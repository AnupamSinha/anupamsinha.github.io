...
| Java Concurrency Patterns Every Senior Developer Must Know | — |
| Java Memory Management: GC Tuning That Actually Works | — |
| Why Your Spring Boot App Is Slow (12 Common Causes) | — |
| How I Handle 1 Million Requests/Second with Java | — |
| Spring Boot 4.0: Everything That's Changing | — |
| Production-Ready REST APIs — The Complete Checklist | — |
...
| I Replaced My Backend Team with AI Agents | — |
| Build Your Own Copilot with Spring AI and RAG | — |
| The AI Tools I Use Daily as a Java Architect | — |
| Why Every Java Developer Should Learn MCP | — |
...
| Stop Using Microservices — A Senior Architect's Confession | — |
| The Architecture Decision That Saved $2M/Year | — |
| The Death of REST? Why gRPC and GraphQL Are Winning | — |
| Design Patterns That Actually Matter in 2026 | — |
| Event-Driven Architecture from Scratch | — |
| Event Sourcing: When It Makes Sense | — |
| Microservices Communication Patterns | — |
| Monolith to Microservices — A Battle-Tested Playbook | — |
| Saga Pattern: Orchestration vs Choreography | — |
| Distributed Locking: 5 Approaches Compared | — |
| Idempotency in Distributed Systems | — |
| Database Sharding with Spring Boot | — |
...
| OAuth2 Explained Like You're Building It | — |
| 7 Spring Boot Security Mistakes That Get You Hacked | — |
...
| Spring Cloud Contract Testing | [31-contract-testing](https://github.com/AnupamSinha/spring-boot-examples/tree/main/31-contract-testing) |
| Load Testing with Gatling | [32-gatling](https://github.com/AnupamSinha/spring-boot-examples/tree/main/32-gatling) |
...
| The Ultimate Docker Compose (15 Services, One File) | — |
| Spring Boot Monitoring: Zero to Production in 20 Minutes | — |
| Automate Deployment with 50 Lines of YAML | — |
...
| Chat Application with WebSocket, Kafka, Redis | — |
| Design Twitter's Timeline — With Working Code | — |
| How I Ace System Design Interviews | — |
...
| 17 Years in Java — The 10 Mistakes That Cost Me Promotions | — |
| Why Senior Developers Are Mass-Quitting in 2026 | — |
| How Senior Engineers Think Differently | — |
| The Technical Debt Strategy That Gets Management Buy-In | — |
